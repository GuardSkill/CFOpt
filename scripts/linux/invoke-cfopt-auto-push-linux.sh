...
COUNTRIES_CSV="${COUNTRIES_CSV:-HK,JP,KR,SG,PH,VN,MY,KZ,MN,IE,US,DE,GB,NL,IT}"
...
FOCUS_COUNTRIES_CSV="${FOCUS_COUNTRIES_CSV:-HK,KR,JP,SG,DE,GB,NL,IT}"
...
PROXYIP_BEST_COUNTRIES="${PROXYIP_BEST_COUNTRIES:-LU,KR,IE,HK,SG,JP,DE,GB}"
