...
try {
    ...
    Write-Warning "Task Scheduler cmdlets could not install the daily trigger; falling back to schtasks.exe: $($_.Exception.Message)"
...
Write-Host "It will run daily at $DailyAt and catch up when the computer next becomes available."
