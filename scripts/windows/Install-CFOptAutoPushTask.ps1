...
$argument = "-NoProfile -ExecutionPolicy Bypass -File `"$ScriptPath`" -WorkDir `"$WorkDir`" -CfstPath `"$CfstPath`" -FocusCountries `"SG,HK,JP,KR,DE,GB`" -IpZipCountrySampleMultipliers `"KR=2,US=0.5`""
